...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchLatestSession = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/api/zone2/sessions/latest`);
  ...
  return (
    <div>
      ...
      >
        ...
        <BarChartComponent zone={zone} weeks={weeks} zoness={'zone2'} />
        <LineChartComponent zones={'zone2'} />
